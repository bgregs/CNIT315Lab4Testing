...
int testConcat()
{
	...
	char strWordResponse1 = NULL, strWordResponse2 = NULL;
	for (e=0; e<numArrays; e++)
	{
		strLength = strings[e].length;
		char *string = malloc(strLength);
		...
		//returnValue = findConcat(&strWordResponse1, &strWordResponse2);

		if (returnValue != 0)
		{
			return 1;
		}
		else if (strWordResponse1 == NULL || strWordResponse2 == NULL)
		{
			return -2;
		}
		else if (strWordResponse != numWords)
		{
			return -1;
		}
